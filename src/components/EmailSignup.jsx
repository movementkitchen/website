...
export default class EmailSignup extends React.Component {
	...
	render() {
		...
		const formAction = this.props.formAction || "https://app.convertkit.com/forms/6946600/subscriptions"
			...
			<div>
				...
				{this.state.formSubmitted ?
					...
					(<form
						...
						data-sv-form="6946600" data-uid="3c230f6b48" data-format="inline" data-version="5"
					>
						<FlexP>
